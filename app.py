...
<div class="main-header">
    ...
    <p>Tác giả: Đinh Thị Thanh Thảo - Trường PTDTBT Tiểu học Quảng Nguyên - ĐT: 083 8172 488</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Đinh Thị Thanh Thảo - Trường PTDTBT Tiểu học Quảng Nguyên - ĐT: 083 8172 488</div>", unsafe_allow_html=True)
